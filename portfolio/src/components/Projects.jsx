        ...
        <div name="projects" className="bg-linear-to-r from-blue-950 to-slate-950 px-8 py-8 md:px-15 lg:px-12 xl:px-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 my-10 sm:mx-18 md:mx-10 lg:mx-15 xl:mx-20">
                <a href="https://github.com/rounakseth0705/Student-ERP" target="_main">
                    <span className="flex flex-col justify-center items-center gap-3 py-5 bg-slate-950 border border-gray-600 cursor-pointer shadow-2xl rounded-2xl hover:shadow-lg hover:shadow-purple-600 hover:border-purple-500 hover:scale-103 active:border-purple-500 active:shadow-lg active:shadow-purple-600 active:scale-107 transition-all duration-800 ease-in-out">
